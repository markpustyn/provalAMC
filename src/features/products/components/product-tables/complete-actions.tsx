...
const generateReport = async (id: string) => {
  try {
    ...
    const blob = await ReactPDF.pdf(<GeneratePdf rating={rating} vendorDetails={orderRecord.vendor} orderDetails={data} orderData={orderRecord.form} images={images} tags={tags} logoSrc="/blackLogo.png"/>).toBlob();
